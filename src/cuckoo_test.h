...
#ifndef FILTERS_CUCKOO_TEST_H
#define FILTERS_CUCKOO_TEST_H
...
namespace cuckooFilter {
    ...
    public:
        ...
        CuckooFilter_test(int n, double fpr, bool construct, int b);
