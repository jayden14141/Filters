...
#ifndef FILTERS_TABLE_TEST_H
#define FILTERS_TABLE_TEST_H
...
//        std::bitset<68> data;
    ...
    public:
        ...
        explicit Table_test(int b, int f, int m) : numberOfEntry(b), fingerPrintSize(f), numberOfBuckets(m) {
            buckets = new Buckett[m];
