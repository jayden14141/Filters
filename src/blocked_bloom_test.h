...
#ifndef FILTERS_BLOCKED_BLOOM_TEST_H
#define FILTERS_BLOCKED_BLOOM_TEST_H
...
namespace blockedBloomFilter {
    class BlockedBloom_test{
    public:

        BlockedBloom_test(int n, double fpr, bool construct, double beta);
...
#endif //FILTERS_BLOCKED_BLOOM_TEST_H
